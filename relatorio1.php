    ...
    <div class="container">
      <div class="container-fluid" id="no-more-tables">
        ...
        <?php
            ...
            $sqlUnidade = 'select cras from cadastro where dataentrega IS NOT NULL and id_campanha = 1  group by cras';
            $queryUnidade = mysqli_query($con,$sqlUnidade);

            $sqlLocalEntrega = 'select localentrega from cadastro where dataentrega IS NOT NULL and id_campanha = 1 group by localentrega';
    ...
    <script type="text/javascript">
      ...
      $(document).ready(function(){
          $('#relatorioCestas').DataTable({
              ...
              'serverMethod': 'post',
              'ajax': {
                  'data': {tipoRelatorio: 'cestasentregues'},
